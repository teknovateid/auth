...
trait InstallsBladeStack
{
    ...
    protected function installBladeStack()
    {
        ...
        (new Filesystem)->copyDirectory(__DIR__.'/../../stubs/default/database/migrations', database_path('migrations'));
        ...
        (new Filesystem)->copyDirectory(__DIR__.'/../../stubs/default/database/factories', database_path('factories'));
        ...
        // env
        (new Filesystem)->copy(__DIR__.'/../../stubs/default/.env', base_path('.env'));
